...
# 忽略输出
$_ = bz.exe c -l:9 -y -fmt:zip -t:14 -cp:65001 .\zed-zip\$zip_name .\Zed.exe
$_ = bz.exe c -l:9 -y -fmt:zipx -t:14 -cp:65001 .\zed-zip\$zip_namex .\Zed.exe
$_ = bz.exe t .\zed-zip\$zip_name
$_ = bz.exe t .\zed-zip\$zip_namex
